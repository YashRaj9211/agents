...
export function App() {
  const [activeTab, setActiveTab] = useState<'chat' | 'catalogue' | 'sandbox'>('chat');

  // ── Catalogue demo state ───────────────────────────────────────────────────
  ...
  const [surfaceState, setSurfaceState] = useState<A2uiSurfaceState>({
    ...
    components: [
      ...
      { id: 'title', component: 'Text', text: 'Firecrawl API Configuration', variant: 'headline-md' },
      {
        id: 'subtitle',
        component: 'Text',
      ...
      { id: 'url-input', component: 'Input', label: 'Target URL', value: { path: '/userQuery' }, placeholder: 'https://example.com' },
      { id: 'subdomain-check', component: 'Checkbox', label: 'Include all subdomains during crawl', value: { path: '/enableSubdomains' } },
      {
        id: 'format-select',
        component: 'Dropdown',
        label: 'Output Format',
      ...
      { id: 'limit-range', component: 'Range', label: 'Max Pages to Crawl', value: { path: '/crawlLimit' }, min: 1, max: 200, step: 5 },
    ],
  });

  const [jsonInput, setJsonInput] = useState(JSON.stringify(surfaceState, null, 2));
  const [jsonError, setJsonError] = useState<string | null>(null);
  const [actionLogs, setActionLogs] = useState<
    Array<{ timestamp: string; action: string; componentId: string; context?: unknown }>
  >([]);
  ...
  const logAction = (actionName: string, componentId: string, context?: unknown) => {
    setActionLogs((prev) => [
      { timestamp: new Date().toLocaleTimeString(), action: actionName, componentId, context },
      ...prev.slice(0, 19),
    ]);
  };

  const updateSandboxDataModel = (path: string, val: unknown) => {
  ...
  const tabs = [
    ...
    { id: 'catalogue' as const, label: 'Component Catalogue' },
    { id: 'sandbox' as const, label: 'A2UI Sandbox' },
  ] as const;

  return (
    <div className="min-h-screen bg-[#F9F9F9] text-[#262626] flex flex-col font-sans">
      {/* Navigation Header */}
      <header className="bg-[#FFFFFF] border-b border-[#E5E7EB] sticky top-0 z-20 px-6 py-3">
        <div className="max-w-full mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="typography-headline-sm font-semibold tracking-tight">Agent Explorer</span>
      ...
      {/* Agent Chat Tab — full height, no padding wrapper */}
      {activeTab === 'chat' && <AgentChat />}

      {/* Catalogue & Sandbox Tabs */}
      {activeTab !== 'chat' && (
          ...
          {activeTab === 'catalogue' && (
            <div className="flex flex-col gap-8">
              <div className="flex flex-col gap-2 max-w-2xl">
                ...
                <h1 className="typography-headline-display">A2UI Component Catalogue</h1>
                <p className="typography-body-lg text-[#6B7280]">
                  A clean, high-contrast SaaS component system for modern agent web apps.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="firecrawl-card flex flex-col gap-4">
                  <div className="flex items-center justify-between border-b border-[#E5E7EB] pb-3">
                    <h3 className="typography-headline-sm">1. Text</h3>
                    <span className="typography-micro uppercase tracking-wider text-[#6B7280] bg-[#F9F9F9] px-2 py-0.5 rounded border border-[#E5E7EB]">Primitive</span>
                  </div>
                  <div className="space-y-3 bg-[#F9F9F9] p-4 rounded-lg border border-[#E5E7EB]">
                    ...
                    <Text text="Standard Body Text (16px)" variant="body-md" />
                ...
                <div className="firecrawl-card flex flex-col gap-4">
                  <div className="flex items-center justify-between border-b border-[#E5E7EB] pb-3">
                    <h3 className="typography-headline-sm">2. Input</h3>
                    <span className="typography-micro uppercase tracking-wider text-[#6B7280] bg-[#F9F9F9] px-2 py-0.5 rounded border border-[#E5E7EB]">Primitive</span>
                  </div>
                ...
                <div className="firecrawl-card flex flex-col gap-4">
                  <div className="flex items-center justify-between border-b border-[#E5E7EB] pb-3">
                    <h3 className="typography-headline-sm">3. Checkbox</h3>
                    <span className="typography-micro uppercase tracking-wider text-[#6B7280] bg-[#F9F9F9] px-2 py-0.5 rounded border border-[#E5E7EB]">Primitive</span>
                  </div>
                  <div className="flex flex-col gap-4 bg-[#F9F9F9] p-4 rounded-lg border border-[#E5E7EB]">
                    <Checkbox
                    ...
                    <div className="p-3 bg-[#FFFFFF] rounded-xl border border-[#E5E7EB] text-sm">
                      ...
                      <span className="font-mono text-[#FA5D19] font-medium">{isCheckxChecked ? 'true' : 'false'}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="firecrawl-card flex flex-col gap-4">
                  <div className="flex items-center justify-between border-b border-[#E5E7EB] pb-3">
                    <h3 className="typography-headline-sm">4. Dropdown</h3>
                    <span className="typography-micro uppercase tracking-wider text-[#6B7280] bg-[#F9F9F9] px-2 py-0.5 rounded border border-[#E5E7EB]">Primitive</span>
                  </div>
                  <div className="flex flex-col gap-4 bg-[#F9F9F9] p-4 rounded-lg border border-[#E5E7EB]">
                    <Dropdown
                ...
                <div className="firecrawl-card flex flex-col gap-4 md:col-span-2">
                  <div className="flex items-center justify-between border-b border-[#E5E7EB] pb-3">
                    <h3 className="typography-headline-sm">5. Range</h3>
                    <span className="typography-micro uppercase tracking-wider text-[#6B7280] bg-[#F9F9F9] px-2 py-0.5 rounded border border-[#E5E7EB]">Primitive</span>
                  </div>
                ...
                <div className="firecrawl-card flex flex-col gap-4">
                  <div className="flex items-center justify-between border-b border-[#E5E7EB] pb-3">
                    <div className="flex items-center gap-2">
                      <span className="w-2.5 h-2.5 rounded-full bg-[#FA5D19] animate-pulse" />
